...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<?php
		...
		<div class="form-control btn btn-info text-white w-100 mt-4 fw-semibold shadow-sm"><button type="submit" class="btn btn-primary" name="login">Iniciar Seccion</button></div>
