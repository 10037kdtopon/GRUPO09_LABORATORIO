		...
		<div class="container mt-3">
		  <div class="table-responsive">
			<div class="table table-hover" align="center">
			  <table class="table table-bordered table-secondary" align="center">
				<tr align="center">
				  <th colspan="2"><button class="btn btn-outline-success"><a href="medicos.php">Regresar</a></button></th>
				</tr>
				<tr>
				  <th colspan="2" class="text-center align-middle table-info">DATOS DE LOS MÉDICOS</th>
				</tr>
				<tr>
				  <td>Nombre:</td>
				...
				<tr>
				  <td>Especialidad:</td>
				  <td>' . $this->_get_combo_db("medicos", "Especialidad", "Especialidad", "Especialidad", $this->Especialidad) . '</td>
				</tr>
				<tr>
				  <td>Usuario Id:</td>
	...
	public function get_list(){
		...
		<div class="table-responsive">
		  <table class="table table-hover table-bordered text-center align-middle">
			<tr>
			  <th colspan="8" class="text-center align-middle custom-table-title">LISTA DE LOS MÉDICOS</th>
			</tr>
			<tr>
